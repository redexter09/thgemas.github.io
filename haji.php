...
<html>
	...
	<body>
		<nav>
			...
			<ul>
				<li><a href="hj.php">Kemaskini Fail</a></li>	
			</ul>
		</nav>
		<style> *
			  ...
			  <tr>
				...
				<?php
					...
					<tr>
					 ...
					 <td> <a href="hj.php?edited=1&id=<?php echo $row['id']; ?>">Sunting</a> |  
						  <a href="hj.php?deleted=1&id=<?php echo $row['id']; ?>">Padam</a> 
					 </td>
					 </tr>
					 <?php
					 }
