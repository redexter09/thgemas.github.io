...
<html>
	<head>
		...
		{
				//add new student
				$sql="insert into pemasaran(namafail,norujukan,lokasi,bilterkini) values
		...
		else
		{
				...
				$sql2="update pemasaran set namafail='$namafail', norujukan='$norujukan', lokasi='$lokasi', bilterkini='$bilterkini'  where id='{$_GET['id']}' ";        

				$result2=$mysqli->query($sql2);     
					if($result2)     
				{      
					header('Refresh:0; pemasaran.php');        
				}
		}
		}
		}
		...
		if(isset($_GET['edited'])) 
			{  
				$sql3="select * from pemasaran where id='{$_GET['id']}' ";  
			...
			if(isset($_GET['deleted'])) { 
				$sql4="delete from pemasaran where id='{$_GET['id']}' ";  
