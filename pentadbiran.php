...
<html>
	<head>
		<meta charset="utf-8">
		<title> Pentadbiran | TH Gemas </title>
	...
	<body>
		<nav>
			...
			<ul>
				<li><a href="pptd.php">Kemaskini Fail</a></li>	
			</ul>
		</nav>
		<style> *
		...
		h2 {
			...
			<h2 align="center"><br>Pentadbiran<br></h2>
			<br>
			  ...
			  <tr>
				...
				<?php
					...
					<tr>
					 ...
					 <td> <a href="pptd.php?edited=1&id=<?php echo $row['id']; ?>">Sunting</a> |  
						  <a href="pptd.php?deleted=1&id=<?php echo $row['id']; ?>">Padam</a> 
					 </td>
					 </tr>
					 <?php
					 }
