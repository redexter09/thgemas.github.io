...
<html>
	<head>
		<meta charset="utf-8">
		<title> Pemasaran | TH Gemas </title>
	...
	<body>
		<nav>
			...
			<ul>
				<li><a href="pms.php">Kemaskini Fail</a></li>	
			</ul>
		</nav>
		<style> *
		...
		h2 {
			...
			margin-left: 80px;
					...
					<h2 align="center"><br>Pemasaran<br></h2>
			<br>
			  ...
			  <tr>
				...
				<?php
					...
					<tr>
					 ...
					 <td> <a href="pms.php?edited=1&id=<?php echo $row['id']; ?>">Sunting</a> |  
						  <a href="pms.php?deleted=1&id=<?php echo $row['id']; ?>">Padam</a> 
					 </td>
					 </tr>
					 <?php
					 }
